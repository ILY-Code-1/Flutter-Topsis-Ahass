...
class _AddBarangMasukDialogState extends State<AddBarangMasukDialog> {
  ...
  final List<_MasukRow> _rows = [_MasukRow()];
                    ...
                    return SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        style: OutlinedButton.styleFrom(
                          ...
                          side: BorderSide(
                            color: canAdd ? AppColors.success : AppColors.border,
                          ),
  ...
  Widget _buildRow(int index, BarangMasukController controller) {
  ...
  void _submit(BarangMasukController controller, AuthService authService) {
    ...
    Get.back();
    controller.addBarangMasuk(records);
  }
}
