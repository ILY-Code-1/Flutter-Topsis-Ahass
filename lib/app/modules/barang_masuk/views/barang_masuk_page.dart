...
import '../widgets/add_barang_masuk_dialog.dart';

class BarangMasukPage extends GetView<BarangMasukController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      drawer: const StaffDrawer(currentRoute: '/barang-masuk'),
      appBar: AppBar(
        elevation: 0,
          ...
          child: Center(
            child: Column(
              children: [
                ...
                Text(
                  'Tekan tombol + BARANG MASUK untuk mencatat transaksi',
                  style: AppTextStyles.bodyMedium.copyWith(
